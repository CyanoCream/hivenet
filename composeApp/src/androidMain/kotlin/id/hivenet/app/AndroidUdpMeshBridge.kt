...
class AndroidUdpMeshBridge(context: Context) : MeshBridge {
    ...
    override fun start(localPeerId: String): MeshBridgeResult = wrap {
        ...
        socket = newSocket
        running = true
        receiveThread = thread(name = "hivenet-udp-receiver", isDaemon = true) {
    ...
    private fun startTcpFallback() {
        ...
        tcpReceiveThread = thread(name = "hivenet-tcp-receiver", isDaemon = true) {
            while (running) {
                try {
    ...
    private fun acquireMulticastLock() {
        ...
        multicastLock = wifiManager.createMulticastLock("hivenet-udp").apply {
    ...
    private companion object {
        ...
        const val SERVICE_TYPE = "_hivenet._tcp."
